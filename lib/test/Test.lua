...
setup("nil or number", function(v) return isnil(v) or isnumber(v) end)
setup("nil or numeric", function(v) return isnil(v) or isnumeric(v) end)
setup("nil or table", function(v) return isnil(v) or istable(v) end)